...
@customElement('app-sent')
export class AppSent extends LitElement {
  ...
  private loadEmails() {
    this.emails = EmailService.getSent();
  }
                ...
                ${this.emails.map(
                  (email) => html`
                    <a class="email-item" href="${resolveRouterPath(`email/${email.id}`)}">
                      <sl-icon class="email-icon" name="send"></sl-icon>
                      <div class="email-content">
                        <div class="email-header">
                          <span class="email-to">
                            <span class="email-to-label">To: </span>${email.to}
                          </span>
